...
Often, our experiments don't go as planned. This question will test your knowledge in resolving a question with realistic problems.
...
# If you completed question 1 correctly, the distribution of DistanceWalked should now look much more normal.
  plot(density(KittyCatch$DistanceWalked))
