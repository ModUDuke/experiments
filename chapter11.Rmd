...
## Putting it All Together with KittyCatch
...
*** =instructions
- 1-8) Explore the data
- 9-13) Balance the data
- 14-18) Correct for coding errors in the data
- 19-20) Calculate the ATE and check for statistical significance
...
test_object("Solution8")
test_object("Solution9")
test_object("Solution10")
test_object("Solution11")
test_object("Solution13")
test_object("Solution14")
test_object("Solution15")
test_object("Solution16")
test_object("Solution17")
test_object("Solution18")
test_object("Solution19")
test_object("Solution20")
