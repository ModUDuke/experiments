...
--- type:NormalExercise lang:r aspect_ratio:62.5 xp:100 skills:2 key:11aa1bb0da
...
--- type:NormalExercise lang:r aspect_ratio:62.5 xp:100 skills:2 key:7a39e3fee6
...
# 3) Top coding can be arbitrary (and there are better methods for handling outliers), but for this assignment, use the following syntax as a model to create an ifelse statement that says that any value of DistanceWalked over 2 will be changed to equal 2:
    dataframe$variable<-ifelse(dataframe$variable>x,y,dataframe$variable). #Note: x is the current value of the variable, and y is the final value we want.
...
--- type:NormalExercise lang:r aspect_ratio:62.5 xp:100 skills:2 key:4d6d2d8bf2
...
--- type:NormalExercise lang:r aspect_ratio:62.5 xp:100 skills:2 key:7c37576a8f
...
--- type:NormalExercise lang:r aspect_ratio:62.5 xp:100 skills:2 key:f0b1e58f5c
