...
## Multiple Choice: Bad proxy variable
A scientist conducts an experiment that studies how attending church effects one's happiness. Since the scientist was trained as an economist, instead of directly measuring the effect of religious attendance on his sample's subjective happiness, he decides to study the effect of religious attendance on a proxy variable for happiness - income - which is known to be correlated with and causal of happiness. The economist studies a large sample of non-religious people, and has half of them attend church weekly, and the other half not attend church at all. After a year, the economist asks his sample to report their incomes and, to his own unhappiness, finds no statistically significant average treatment effect of religious attendance on happiness (measured as income). If in reality, church attendance is causal of happiness, which answer is **NOT** a possible explanation for why the experiment failed to produce a statistically significant effect?

*** =instructions
- Income is a poor proxy for happiness
- Across the population, income is not associated with church attendance
- Relgious attendance has a heteroskedastic effect on income
- The effect of religious attendence on income takes longer than a year to realize
*** =sct
```{r}
msg1 = "This statement could cause the experiment to fail to produce a statistically significant result. Using a poor proxy variable can definitely induce a null effect. Try again"
msg2 = "Correct! This statement could not cause the experiment to fail to produce a statistically significant result. Since we are conducting an experiment, we can directly control who goes to church and who does not. Therefore whether there is an association between income and church attendance among the population is irrelevant to our experimental results"
msg3 = "This statement could cause the experiment to fail to produce a statistically significant result. If the effect of religious attendance on income was heteroskedastic, it could mask an average treatment effect across the entire sample. Try again"
msg4 = "This statement could cause the experiment to fail to produce a statistically significant result. If a treatment effect takes a long time to realize, it might produce a null effect over the course of a short time span. Try again"
...
#Deterimine the average treatment effect of




--- type:MultipleChoiceExercise lang:r xp:50 skills:1 key:ad38b7984c
