...
# Question 1: Using a t-test, assess the validity of this natural experiment by comparing the take-up rate of those who were offered the increase and experienced rainy weather (variable "rainy") vs. those who were offered the increase but did not experience rain.
#---- Question 1-------------------------------------#
    Solution1<-
#----------------------------------------------------#
...
# Question 3: Compute the treatment effect of the offer by calculating the average post-treatment balance level for rainy-day customers versus sunny-day customers (regardless of whether they were offered the balance increase). Use a t-test to report these results.
#---- Question 3-------------------------------------#
    Solution3<-
#----------------------------------------------------#
