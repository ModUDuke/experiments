...
es income cause happiness? It is generally believed that income increases happiness for those who have less money. So a bump in income for a poor person is likely to increase his happiness much more than the same bump in income for a wealthy person. 

Siggy, an academic psychologist, was interested in how one time cash rewards effect happiness. Siggy decided to conduct an experiment by giving people a $10 bill, and measuring whether their happiness at that moment changed. If Siggy only conducted this experiment on college students (a domegraphic that is usually strapped for cash, but an convenient sample for academics to conduct experiment on), how might we expect it to bias his experiment's average treatment effect?
