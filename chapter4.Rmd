...
#Note: This question does not specify with what confidence, so the answer is simply the commute time that is greater or equal to 95% of the observations in the dataset. To solve this question, we would recommend using the "quantile" function. The quantile function requires two arguments, a variable (Commute) and a quantile to be returned (.95). 

#---- Question 1-------------------------------------#
    Solution1<- quantile(var,quantile)
#----------------------------------------------------#

# 2) How long should Donny leave himself if he wants to arrive to work on time at least 50% of the time, with 95% confidence? 

#Note: Another way of stating the question is: given our limited sample, at what time are we 95% confident that Donny could leave and get to work on time half of the time? We can do this by examining the confidence interval on the mean of Donny's commute times; specifically, the upper bound of its 95% confidence interval. The confidence interval of a mean is determined with the t.test function; the upper bound can be returned with t.test(VARIABLE)$conf.int[2].
