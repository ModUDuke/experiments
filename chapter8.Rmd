...
# 3) Calculate the average treatment effect, which is is simply the mean outcome of the treatment group minus the mean outcome of the control group.
...
# 1)Determine the average treatment effect among men. 
...
Solution1<-t.test(econometrics$Income[econometrics$Treatment==1],econometrics$Income[econometrics$Treatment==0])$p.value
Solution2<-t.test(econometrics$Happiness[econometrics$Treatment==1],econometrics$Happiness[econometrics$Treatment==0])$p.value
```
