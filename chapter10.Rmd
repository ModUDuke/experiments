...
Although it is wholly misleading, one way that unethical scientists justify their assumptions that their studies are "as-if" natural experiments (i.e. with basically random assignment) when they are clearly not, is by stating where their data is balanced. Let's give it a try.

The dataset `KatyPerry` contains covariate data from a natural experiment about how repeated exposure to music performed by Katy Perry (measured as owning a Katy Perry album) is associated with psychopathy. The scientists who gathered this data want to publish an article about how Katy Perry's music should be blacklisted, since it appears to be harmful to the public's mental health, but their "natural experiment" of exposure to Katy Perry music is not very balanced. Help them justify their assumption! Search through the variables in `KatyPerry` and name one trait where the treatment and control groups are balanced.
...
--- type:MultipleChoiceExercise lang:r xp:50 skills:1 key:a9d826e1d0
## Explaining the Results of Natural Experiments
The experiment described in this module uses many kinds of evidence to argue that the situation was an as-if natural experiment.  Two ways of explaining the results are the "experience hypothesis", that the squatters' change in behavior was changed after their new social experiences, and the "motivated beliefs" hypothesis, that they changed their behavior early in the process in anticipation of how their life could change.  Which do you think is more likely?

*** =instructions
- Experience Hypothesis
- Motivated Beliefs Hypothesis
*** =hint
- Here is a useful hint: Answer 3 is the right answer
*** =sct
```{r}
msg1 = "There are good arguments on both sides, and many people have argued that either side is correct. These kinds of questions are usually best answered by collaborative work by experts from many fields to provide a more complete view of the issues-and even then there will be plenty of disagreement!"
msg2 = "There are good arguments on both sides, and many people have argued that either side is correct. These kinds of questions are usually best answered by collaborative work by experts from many fields to provide a more complete view of the issues-and even then there will be plenty of disagreement!"
test_mc(correct = c(1,2), feedback_msgs = c(msg1,msg2))
```
...
When visiting a zoo, a sea otter enthusiast and his associate got into a heated debate regarding which is more amusing to watch: a sea otter eating clams or sea urchins. Despite how strange sea urchins appear, the sea otter enthusiast was convinced that it is more amusing to watch sea otters place clams on their bellies and use stones to crack them open prior to eating, whereas his associate believed the opposite. 

To resolve this contentious and *highly consequential* debate, the two friends visited the zoo during feeding hours several times, and counted how many people watched the sea otters when they were fed clams versus when they were fed sea urchins. Although their average treatment effects was positive (ATE = 8.33 people) With a 95% confidence interval, their results were inconclusive. Although the results were somewhat suggestive of a positive treatment effect, the results were not statistically significant (CI = -0.23 - 16.94). However, the sea otter enthusiast believes that a 95% confidence interval is too stringent a standard for determining statistical significance, and his associate believed that a 95% confidence interval was not stringent enough. Using the dataset `SeaOtter`:
...
This is a question
*** =instructions
- The experiment could not show whether or how property rights affects teenage pregnancy 
...
- Property rights does not change the rate of teenage pregnancy at all
- Property rights causes the rate of teenage pregnancy to go up a little because teens now had a home for their children. 
*** =sct
```{r}
