...
--- type:NormalExercise lang:r aspect_ratio:62.5 xp:50 skills:1 key:87c93c97ab
...
# Note: The t-test shows a difference in the number of black phones in each group, but is that difference statistically significant? Take a look at the p-value. Because the p-value is 0.46, which is well above .05, we can say that the difference is not statistically significant.
