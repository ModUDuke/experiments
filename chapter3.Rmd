...
# As a reminder, the last line of the t.test function results shows the two estimated means for the X and Y variables that we inserted into the function. To get the difference between these means, you'll need to do a separate subtraction by hand. 
