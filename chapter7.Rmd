...
If the values of an experiment's outcome variable are associated with a systematic difference between compliers and noncompliers, its association with the treatment effect may be spurious. Therefore, we should test our data to see whether compliance was associated with any traits among the sellers, and whether such traits were associated with final sales prices. With the dataset `eGulf`:
...
- 2) Test whether sellers' prior average feedback scores were associated with their recent auction's final sales price (`Final_Sales_Price`).
...
# 2) Before running a significance test to see whether compliers and noncompliers were different, let's summarize the data. Select the following code and hit the "Run Code" button to see the results:
...
# 1) Compute the fraction of people who were offered a higher credit limit.
#---- Question 1-------------------------------------#
    Solution1<- 
#----------------------------------------------------#

# 2) Of the people who were offered, what fraction opted in?
#---- Question 2-------------------------------------#
    Solution2<- 
#----------------------------------------------------#
