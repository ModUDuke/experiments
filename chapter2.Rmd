...
*** =sample_code
```{r}
PhoneSpecifications #Print dataframe to console

Solution1<-    #Write column name of specification with the largest ratio between the WePhone 10S and the Universe S10 (Must be a character)

Solution2<-    #Return quotient of phone specifications selected in Solution1 (do not round!)
