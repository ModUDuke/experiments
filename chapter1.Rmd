...
msg2 = "This is a possible explanation for the correlation between eBay sales and rainfall in Sonoma County, but it is not a causal relationship. Instead it would suggests that this correlation is spurious. Try again"
...
msg4 = "Good Job. As ridiculous as this sounds, it is what a causal relationship between rainfall in Sonoma County and eBay sales might suggest. Of course, residents of Sonoma County would have to have providing a huge proportion of all eBay transactions for the correlation we to hold."
...
-Most people only shop on eBay with Apple iphones.
-Buying an iPhone makes people more comfortable with using technology for market transactions.

*** =sct
```{r}
msg1 = "This would suggest a causal relationship. Try again"
msg2 = "Correct! This would cause both iPhone and eBay sales to increase."
msg3 = "This would suggest a causal relationship. Try again"
msg4 = "This would suggest a causal relationship. Try again"
